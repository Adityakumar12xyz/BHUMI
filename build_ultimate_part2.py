# -*- coding: utf-8 -*-
"""
build_ultimate_part2.py
Constructs the complete, robust JavaScript code for BHUMI-INSIGHT with
unmistakable visual and functional differences across all 5 roles:
- 🏛️ Govt Officer (DoLR / State Revenue)
- 🏫 Research Institution / University
- 🔬 Academic Researcher
- 📋 State Evidence Reviewer
- 👥 Citizen (Public User)
"""
...
with open('bhumi_app_part2.js', 'w', encoding='utf-8') as f:
    f.write(js_code)

print("Part 2 JavaScript written successfully!")

# Now compile bhumi-insight-v2.html by combining bhumi_ultimate_part1.html + bhumi_app_part2.js + closing tags
with open('bhumi_ultimate_part1.html', 'r', encoding='utf-8') as f:
    part1_html = f.read()

full_html = part1_html + "\n\n" + js_code + "\n</script>\n</body>\n</html>\n"

with open('bhumi-insight-v2.html', 'w', encoding='utf-8') as f:
    f.write(full_html)

print("bhumi-insight-v2.html compiled successfully! Size:", len(full_html), "bytes")
